  ...
  template: `
    <nav class="header">
      ...
      <div *ngIf="mobileOpen" class="mobile-menu">
        <a routerLink="/" (click)="mobileOpen=false">Accueil</a>
        <a routerLink="/projects" (click)="mobileOpen=false">Projets</a>
        <a routerLink="/experience" (click)="mobileOpen=false">Expérience</a>
        <a routerLink="/competences" (click)="mobileOpen=false">Compétences</a>
...
.footer {
  margin-bottom: 0;  // CRITIQUE : Forcer à 0
  padding: 4rem 0 2rem;  // Contrôler uniquement le padding interne
}

.footer-bottom {
  padding-bottom: 0;  // Éliminer le padding bas
  margin-bottom: 0;   // Éliminer la marge basse
}
